...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        try {
            ...
            $contenido = '<html>';
            $contenido .= "<p><strong>Hola " . $fullName .  "</strong> Has Creado tu cuenta en App Salón, solo debes confirmarla presionando el siguiente enlace</p>";
    ...
    public function enviarInstrucciones()
    {
        ...
        try {
            ...
            //Configurar el contenido del mail
            $mail->setFrom('admin@bienesraices.com', 'Admin - BienesRaices.com');
            $mail->addAddress($this->email, $fullName); //Add a recipient
            ...
            $contenido = '<html>';
            $contenido .= "<p><strong>Hola " . $fullName .  "</strong> Has solicitado reestablecer tu password, sigue el siguiente enlace para hacerlo.</p>";
